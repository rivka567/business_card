...
import {User} from 'src/app/app-state/classes/user/user';
import {UserLinks} from 'src/app/app-state/classes/userLinks/user-links';
...
export class AppService {
  ...
  addUserLinks(userLinks):Observable<any>
  {
    debugger
    let array={
      'userLinks':userLinks,
